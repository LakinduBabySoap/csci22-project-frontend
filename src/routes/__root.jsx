      ...
      <ThemeProvider defaultTheme="light" storageKey="vite-ui-theme">
         ...
         <div className="flex items-center justify-center gap-6">
            <nav className="flex items-center gap-8">
               ...
               <Link to="/events" className="text-sm font-medium text-foreground/80 hover:text-foreground hover:underline">
                  Event List
               </Link>
               <Link to="/users" className="text-sm font-medium text-foreground/80 hover:text-foreground hover:underline">
                  User List
               </Link>
               <div className="flex items-center justify-center gap-6">
                  <ModeToggle />
